...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">curl</span> <span class="token parameter variable">-X</span> GET <span class="token string">"https://banking.oks-group.kz/api/v1/service/projects/list"</span> <span class="token punctuation">\</span></span>
